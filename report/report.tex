...
\begin{mathpar}
  ...
  \inferrule[If/Then/Else]{
    ...
    E \vdash \code{if} a_1 \code{then} a_2 \code{else} a_3 : \tau
  }
  \\
  \inferrule[Function Definition]{
    E + F : \tau_f \vdash o_1 : \tau_r
    \and
    E + F : \tau_f \vdash i_n : \tau_n
    \and
    E + F : \tau_f \vdash a_n : \bullet
    \and
    \tau_f = (\tau_n) -> \tau_r
  }{
    E \vdash \code{fundef}\ F\ (i_1, \dots, i_n) (o_1) (a_1, \dots, a_n) : \tau_f
  }
\end{mathpar}

The types of the builtin functions are as follows:
\begin{table}[h!]
\center
\begin{tabular}{c|c}
\hline
